        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 mb-10 tracking-tight">
              Explore our services designed specifically for independent truckers and small fleet owners.
              We help you manage your business more efficiently and maximize profitability.
            </p>
